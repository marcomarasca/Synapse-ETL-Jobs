...
This script contain the methods, which performs mapping on dynamic frame. Glue reads data from s3 source and creates
a dynamic frame. Glue computes the schema for dynamic frame.Apply mapping methods will change the schema,
e.g, field name, datatype.
"""
